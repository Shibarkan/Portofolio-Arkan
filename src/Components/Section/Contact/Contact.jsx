...
const Contact = () => {
  ...
  return (
    ...
    >
      ...
      {/* Contact Card */}
      <motion.div
        className="grid lg:grid-cols-2 items-start gap-10 p-8 max-w-5xl w-full bg-[#0f0f0f] rounded-xl border border-neutral-800 shadow-[0_0_30px_rgba(0,0,0,0.5)] backdrop-blur-sm"
