...
const Contact = () => {
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden p-4">
      ...
      {/* Contact Card */}
      <div className="grid lg:grid-cols-2 items-start gap-12 p-8 mx-auto max-w-4xl max-lg:max-w-2xl bg-[#121212] rounded-md border border-[#2a2a2a] shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
        {/* Left */}
        <div>
          ...
          <div className="mt-12">
            ...
            <ul className="flex mt-4 space-x-4">
              {[
                ...
                <li
                  key={idx}
                  className="bg-[#1f1f1f] hover:bg-[#2d2d2d] h-10 w-10 rounded-full flex items-center justify-center transition"
                >
                  <a
                    href={item.href}
                    target="_blank"
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          {[
            ...
            { id: "subject", label: "Subject", value: subject, setValue: setSubject, type: "text" },
          ].map((input) => (
            <div key={input.id} className="relative">
              <input
                ...
                required
                className="peer w-full bg-transparent text-white rounded-md pt-5 pb-2.5 px-4 border border-[#333] text-sm outline-none focus:border-blue-500"
                placeholder=" "
              />
              <label
                htmlFor={input.id}
                className="absolute left-4 top-2.5 text-sm text-gray-400 transform scale-100 transition-all
          ...
          <div className="relative">
            <textarea
              ...
              required
              className="peer w-full bg-transparent text-white rounded-md pt-5 pb-2.5 px-4 border border-[#333] text-sm outline-none focus:border-blue-500 resize-none"
              placeholder=" "
            ></textarea>
            <label
              htmlFor="message"
